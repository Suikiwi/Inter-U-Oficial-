...
const BASE_URL = 'http://192.168.1.7:8000/'; // Reemplaza con tu IP local o dominio
...
// -------- CHATS --------
// Aquí está la corrección: usamos el endpoint de iniciar chat de publicaciones
export const iniciarChat = async (publicacionId) => {
  const { data } = await api.post(`/publicaciones/${publicacionId}/iniciar-chat/`);
  return data;
};
